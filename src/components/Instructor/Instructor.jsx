        ...
        <div className="container">
          <div className="heading py-12 text-center w-2/3 m-auto md:w-full">
            <h1 className="text-3xl font-semibold text-black">
              What Is <span className=" text-sky-700">Skilline</span>?
            </h1>
            ...
            <div className="images rounded-lg relative overflow-hidden h-72 w-ful before:bg-backbg before:h-72 before:w-full before:absolute before:top-0 before:left-0 before:content before:z-10">
              ...
              <div className="categ flex flex-col gap-4 absolute top-5 z-30 m-3 p-8 items-center justify-center text-center">
                <h2 className="text-3xl text-white font-semibold">
                  <span className=" text-[#003cffd3]">
                    Mostly Online Learning
                  </span>
                </h2>
                <button className="text-[15px] py-2 px-4 border-2 border-[#e7c608] bg-[#f0c13f] rounded-md hover:bg-transparent text-white shadow-[0px_10px_8px_-7px_#ffd978] hover:shadow-[0px_10px_8px_-7px_#69a79c] ">
                  Start a class today
                </button>
              </div>
            </div>
          ...
          <div className="content">
            <div className="heading py-12 text-center w-2/3 m-auto md:w-full">
              <h1 className="text-3xl font-semibold text-black">
                We Are <span className="text-teal-500 text-5xl">Proud</span>
              </h1>
              <span className="text-[14px] mt-2 block">
            ...
            <div className="content grid grid-cols-4 gap-20 md:grid-cols-4 item-center pl-10 justify-center">
              <InstructorCard
                color="text-red-500"
